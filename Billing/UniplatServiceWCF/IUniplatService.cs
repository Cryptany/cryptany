...
namespace UniplatServiceWCF
{
    ...
    {
        private string _MSISDN;             //номер телефона
        private string _paymentId;          //идентификатор платежа
        private string _operatorCode;       //код оператора
        private string _comment;            //комментарий (описание услуги/товара, который приобретает абонент)
        private string _serviceId;          //код сервиса, по которому происходит списание
        private string _partnerCode;        //код партнёра (от кого пришёл запрос)
        private int _amount;                //сумма денег на списание (в копейках)
        private string _hash;               //хэш-значение платежа
        private string _paymentNumber;      //номер платежа
    ...
    {
        private string _paymentId;      //ID платежа
        private string _partnerCode;    //код партнёра
        private string _hash;           //хэш платежа
    ...
    public class Resp
    {
        ...
        {
            get { return _resultСomment; }
            set { _resultСomment = value; }
        }
    }
