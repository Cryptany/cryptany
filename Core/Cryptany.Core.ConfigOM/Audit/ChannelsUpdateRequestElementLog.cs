...
namespace Cryptany.Core.ConfigOM.Audit
{
	[DbSchema("Audit")]
	[Serializable]
	public class ChannelsUpdateRequestElementLog : EntityBase
	{
		...
		[FieldName("RequestElementId")]
		[Relation(RelationType.OneToOne, typeof(ChannelsUpdateRequest), "ID")]
		public ChannelsUpdateRequest RequestElement
		{
			get
			{
				return GetValue<ChannelsUpdateRequest>("RequestElement");
			}
			set
			{
				SetValue("RequestElement", value);
			}
		}
	}
}
