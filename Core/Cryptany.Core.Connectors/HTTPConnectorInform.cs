...
{
    /// <summary>
    /// HTTPConnectorInform class: interacts with InformPartner SMSC by HTTP protocol
    /// </summary>
    public class HTTPConnectorInform : AbstractConnector
    {
        ...
        protected HTTPMessageManagerInform m_HTTPmm;  //ссылка на MessageManager
        ...
        public HTTPConnectorInform(string scheme, string host, string port, string path, string requestURL, string systemID,
                             string salt, HTTPMessageManagerInform httpmm)
            : base(httpmm)
        {
            ...
            catch (Exception e)
            {
                if (Logger != null)
                {
                    Logger.Write(new LogMessage("Exception in HTTPConnectorInform constructor: " + e, LogSeverity.Error));
                }
        ...
        public HTTPMessageManagerInform HTTPmm
        {
            get { return m_HTTPmm; }
            set { m_HTTPmm = value; }
        }
        ...
        private string GetPrefixString(string scheme, string host, string port, string path)
        {
            ...
            catch (Exception e)
            {
                ...
                if (Logger != null)
                {
                    Logger.Write(new LogMessage("Exception in HTTPConnectorInform GetPrefixString method: " + e,
                                                LogSeverity.Error));
                }
                ServiceManager.LogEvent(e.ToString(), EventType.Error, EventSeverity.Critical);
            }
        ...
        public override bool Start()
        {
            ...
            catch (Exception e)
            {
                if (Logger != null)
                {
                    Logger.Write(new LogMessage("Exception in HTTPConnectorInform Start method: " + e, LogSeverity.Error));
                }
                ServiceManager.LogEvent(e.ToString(), EventType.Error, EventSeverity.Critical);
                isOk = false;
            }
        ...
        protected void WaitForData_Rcv()
        {
            ...
            catch (Exception e)
            {
                if (Logger != null)
                {
                    Logger.Write(new LogMessage("Exception in HTTPConnectorInform WaitForData_Rcv method: " + e,
                                                LogSeverity.Error));
                }
        ...
        protected void OnDataReceived(IAsyncResult asyn)
        {
            ...
            catch (Exception e)
            {
                if (Logger != null)
                {
                    Logger.Write(new LogMessage("Exception in HTTPConnectorInform OnDataReceived method: " + e,
                                                LogSeverity.Error));
                }
                ServiceManager.LogEvent(e.ToString(), EventType.Error, EventSeverity.High);
            }
        ...
        public bool Stop(bool discardQueuedRequests)
        {
            ...
            catch (Exception e)
            {
                if (Logger != null)
                {
                    Logger.Write(new LogMessage("Exception in HTTPConnectorInform Stop method: " + e, LogSeverity.Error));
                }
                ServiceManager.LogEvent(e.ToString(), EventType.Error, EventSeverity.High);
                isOk = false;
            }
        ...
        public bool AsyncSend(byte[] bytes, RequestType reqType, string contentType)
        {
            ...
            catch (Exception e)
            {
                if (Logger != null)
                {
                    Logger.Write(new LogMessage("Exception in HTTPConnectorInform AsyncSend method: " + e, LogSeverity.Error));
                }
                ServiceManager.LogEvent(e.ToString(), EventType.Error, EventSeverity.High);
                isOk = false;
            }
        ...
        protected void WaitForData_Snd(byte[] bytes, RequestType reqType, string contentType)
        {
            ...
            catch (Exception e)
            {
                if (Logger != null)
                {
                    Logger.Write(new LogMessage("Exception in HTTPConnectorInform WaitForData_Snd method: " + e,
                                                LogSeverity.Error));
                }
                ServiceManager.LogEvent(e.ToString(), EventType.Error, EventSeverity.High);
            }
        ...
        protected void OnDataSent(IAsyncResult asyn)
        {
            ...
            catch (Exception e)
            {
                if (Logger != null)
                {
                    Logger.Write(new LogMessage("Exception in HTTPConnectorInform OnDataSent method: " + e, LogSeverity.Error));
                }
                ServiceManager.LogEvent(e.ToString(), EventType.Error, EventSeverity.High);
            }
        }
        ...
        public bool Send(byte[] bytes, RequestType reqType, string contentType)
        {
            ...
            catch (Exception e)
            {
                if (Logger != null)
                {
                    Logger.Write(new LogMessage("Exception in HTTPConnectorInform Send method: " + e, LogSeverity.Error));
                }
                ServiceManager.LogEvent(e.ToString(), EventType.Error, EventSeverity.High);
            }
            return isOk;
