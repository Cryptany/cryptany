...
namespace Cryptany.Core
{
	...
	public class Message : ISerializable
	{
        ...
        string _operatorSubscriptionId;
        ...
        public string OperatorSubscriptionId
        {
            get
            {
                return _operatorSubscriptionId;
            }
            set
            {
                _operatorSubscriptionId = value;
            }
        }
		...
		public MsgSerializationInfo SerializationInfo
		{
			get
			{
				...
				//result._Abonent = _abonent;
				//result._ServiceNumber = _sn;
				...
				//result._SMSCount = _SMSCount;
				//result._TariffID = _TariffID;
                ...
                result._operatorSubscriptionId = _operatorSubscriptionId;
				//result._IsSystemMessage = _IsSystemMessage;
				return result;
			}

			set
			{
				//_abonent = value._Abonent;
				//_sn = value._ServiceNumber;
				...
				//_SMSCount = value._SMSCount;
				//_TariffID = value._TariffID;
                ...
                _operatorSubscriptionId = value._operatorSubscriptionId;
				//_IsSystemMessage = value._IsSystemMessage;
			}
		}
		...
		public struct MsgSerializationInfo
		{
            ...
            public string _operatorSubscriptionId;
		}
