...
namespace Cryptany.Core.Base
{
	...
	public abstract class Content
	{
		...
		/// <summary>
		/// Добавляет строку в Downloads (если для данного типа контента эта операция имеет смысл)
		/// </summary>
		/// <param name="saleChannelId"></param>
		/// <param name="tariffId"></param>
        //public virtual void AddToDownloads(System.Nullable<Guid> saleChannelId, System.Nullable<Guid> tariffId, System.Nullable<Guid> abonentId)
        //{ }
